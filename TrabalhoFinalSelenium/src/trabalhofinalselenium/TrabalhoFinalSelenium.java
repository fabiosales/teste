...
public class TrabalhoFinalSelenium {
    ...
    public static void main(String[] args) {
        ...
        campoTweet.sendKeys("Teste Selenium #Selenium #14");
        ...
        //Clica no botão para twittar para o perfil
        ...
        campoTweetarPerfil.sendKeys("Teste Selenium - Disciplina Tópicos Avançados - BSI 8ª fase #UNIDAVI");
